...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * `-------------------------------------------------------------------------------------'   `----'
   */
[_MAIN] = LAYOUT_225u_split_space( /* MAIN */
...
KC_LCTL,      KC_LGUI,    KC_LALT,    __x__,      L_SPACE,                            R_SPACE,    __x__,      KC_RALT,    KC_APP,     KC_RCTL,          KC_MPLY),
   ...
   * `-------------------------------------------------------------------------------------'   `----'
   */
[_LEFT] = LAYOUT_225u_split_space( /* LEFT */
...
KC_TRNS,      KC_TRNS,    KC_TRNS,    __x__,      KC_TRNS,                            KC_TRNS,    __x__,      KC_NO,      KC_NO,      KC_NO,            KC_MPRV),
  ...
  * ,-------------------------------------------------------------------------------------.
   ...
   * `-------------------------------------------------------------------------------------'   `----'
   */
[_RIGHT] = LAYOUT_225u_split_space( /* RIGHT */
KC_F1,        KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_F11,     KC_F12,
KC_NO,        KC_HOME,    KC_END,     KC_PGUP,    KC_PGDN,    KC_NO,      KC_NO,      KC_LEFT,    KC_DOWN,    KC_UP,      KC_RGHT,    KC_NO,
KC_TRNS,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,
KC_TRNS,      KC_TRNS,    KC_TRNS,    __x__,      KC_TRNS,                            KC_TRNS,    __x__,      KC_NO,      KC_NO,      KC_NO,            KC_MNXT),
   ...
   * |-------+------+------+------+------+------+------+------+------+------+------+-------|  F.T+/F.T-/F.B+/F.B-/ - F.lux Temperature +/- Brightness +/-
   * |        |      |      |      | F.T+ | F.T- | F.B+ | F.B- |      |      |      |      |
   * |--------+------+------+------+------+------+------+------+------+------+------+------|    ,----.
   * |       |       |       |                |                    |       |       |       |   |ANIM |
   * `-------------------------------------------------------------------------------------'   `----'
   */
[_BOTH] = LAYOUT_225u_split_space( /* BOTH */
...
KC_NO,        KC_NO,      KC_NO,      KC_NO,      FLUX_T_DN,  FLUX_T_UP,  FLUX_B_DN,  FLUX_B_UP,   KC_NO,     KC_NO,      KC_NO,      KC_NO,
KC_NO,        KC_NO,      KC_NO,      __x__,      KC_NO,                              KC_NO,       __x__,     KC_NO,      KC_NO,      KC_NO,           KC_F13),
};
