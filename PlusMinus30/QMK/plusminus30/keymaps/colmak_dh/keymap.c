...
const uint16_t PROGMEM Tabulator[] = {CTL_A,    SFT_I,   COMBO_END};
const uint16_t PROGMEM CapsLock[]  = {KC_Z,     KC_X,    COMBO_END};
const uint16_t PROGMEM Backspace[] = {KC_Y,     KC_SCLN, COMBO_END};
const uint16_t PROGMEM Enterros[]  = {SFT_I,    CTL_O,   COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_30(
        ...
        CTL_A,    SFT_R,    GUI_S,    ALT_T,    KC_G,     KC_M,     ALT_N,    GUI_E,    SFT_I,    CTL_O,
        KC_Z,     KC_X,     KC_C,     KC_D,     L_SPACE,  R_SPACE,  KC_K,     KC_H,     KC_COMM,  KC_DOT
    ),
    [_LEFT] = LAYOUT_30(
