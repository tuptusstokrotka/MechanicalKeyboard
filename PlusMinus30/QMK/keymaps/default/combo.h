...
const uint16_t PROGMEM Tab1[]       = {MOD_A,    MOD_S,   COMBO_END};
const uint16_t PROGMEM Tab2[]       = {MOD_D,    MOD_F,   COMBO_END};
const uint16_t PROGMEM CapsLock[]   = {KC_Z,     KC_X,    COMBO_END};

const uint16_t PROGMEM Backspace[]  = {KC_O,     KC_P,    COMBO_END};
const uint16_t PROGMEM Enterros[]   = {MOD_L,    MOD_SCLN,COMBO_END};
